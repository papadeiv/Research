...
\end{equation}
%
For a slow passage through the saddle-node bifurcation, i.e. $0<\varepsilon\ll1$, provided that $\mu_0=\lim_{t\to-\infty}\mu(t)\ll0$, the pullback attractor converges to a slow manifold \cite[Thm.~$2.1.7$]{Berglund2006}, which tracks the stable equilibrium branch $x_+(\mu(t))$ at a distance of order at most $\varepsilon^{1/3}$ \cite[Thm.~$2.2.2$]{Berglund2006} at the saddle-node bifurcation.
